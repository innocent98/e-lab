...
export default function CoverPicture() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (coverPicture) {
      ...
      try {
        await userRequest.post("/update", data);
      } catch (err) {
        console.log(err);
      }
    }
    ...
    try {
      const res = await userRequest.put("/publishers/" + user._id, updateUser);
      setSuccess(true);
      ...
      <div className="cover">
        <div className="cover-pic-u">
          ...
          >
            ...
            <label htmlFor="file">
              <span className="prf">
                <span class="material-icons-outlined i">photo_camera</span>
              </span>
            </label>
            <input
              type="file"
